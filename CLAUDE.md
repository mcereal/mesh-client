...
Verified 2026-09-05: 96 unit tests, all passing, zero compiler warnings.
...
| Admin protocol | `src/core/radio_settings.c` | `AdminMessage` get/set queue, passkeys, radio actions |
