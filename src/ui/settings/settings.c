...
#define BEACON_TARGET_ROWS(n)                                                                      \
    [MESH_UI_FIELD_BEACON_TARGET_##n##                                                             \
        _PRESET] = {{MESH_STR_SETTINGS_FIELD_BEACON_TARGET_PRESET, MESH_UI_SETTING_ENUM,           \
                     MESH_UI_SETTINGS_BEACON, BEACON_PRESET_VALUES, beacon_target_preset_name,     \
                     NO_PRESETS, 0U, INKCELL_STR_NONE},                                            \
                    INKCELL_STR_NONE,                                                              \
                    NULL},                                                                         \
   [MESH_UI_FIELD_BEACON_TARGET_##n##                                                              \
       _REGION] = {{MESH_STR_SETTINGS_FIELD_BEACON_TARGET_REGION, MESH_UI_SETTING_ENUM,            \
                    MESH_UI_SETTINGS_BEACON, 38U, beacon_target_region_name, NO_PRESETS, 0U,       \
                    INKCELL_STR_NONE},                                                             \
                   INKCELL_STR_NONE,                                                               \
                   NULL},                                                                          \
   [MESH_UI_FIELD_BEACON_TARGET_##n##                                                              \
       _CHANNEL] = {{MESH_STR_SETTINGS_FIELD_BEACON_TARGET_CHANNEL, MESH_UI_SETTING_NUMBER,        \
...
static const struct field_spec k_fields[MESH_UI_FIELD_COUNT] = {
    ...
    [MESH_UI_FIELD_USER_SHORT_NAME] = {{MESH_STR_SETTINGS_FIELD_USER_SHORT_NAME,
                                        ...
                                        MESH_UI_TEXT_LIMIT_USER_SHORT_NAME, NULL, NO_PRESETS, 0U,
                                        INKCELL_STR_NONE},
                                       INKCELL_STR_NONE,
                                       NULL},
    ...
    [MESH_UI_FIELD_POSITION_SMART] = {{MESH_STR_SETTINGS_FIELD_POSITION_SMART,
                                       ...
                                       NO_PRESETS, 0U, MESH_STR_SETTINGS_NOTE_POSITION_SMART},
                                      INKCELL_STR_NONE,
                                      NULL},
    [MESH_UI_FIELD_POSITION_SMART_DISTANCE] = {{MESH_STR_SETTINGS_FIELD_POSITION_SMART_DISTANCE,
                                                ...
                                                0U, MESH_STR_SETTINGS_NOTE_POSITION_SMART_DISTANCE},
                                               INKCELL_STR_NONE,
                                               format_metres},
    ...
    [MESH_UI_FIELD_POSITION_GPS_INTERVAL] = {{MESH_STR_SETTINGS_FIELD_POSITION_GPS_INTERVAL,
                                              ...
                                              NULL,
                                              SCALE_PRESETS_AFTER_ZERO(k_gps_interval_presets), 0U,
    ...
    [MESH_UI_FIELD_DISPLAY_SCREEN_ON] = {{MESH_STR_SETTINGS_FIELD_DISPLAY_SCREEN_ON,
                                          MESH_UI_SETTING_NUMBER, MESH_UI_SETTINGS_DISPLAY, 0U,
                                          NULL, SCALE_PRESETS_AFTER_ZERO(k_screen_on_presets), 0U,
    ...
    [MESH_UI_FIELD_DISPLAY_MESSAGE_BUBBLES] = {{MESH_STR_SETTINGS_FIELD_DISPLAY_MESSAGE_BUBBLES,
                                                MESH_UI_SETTING_TOGGLE, MESH_UI_SETTINGS_DISPLAY,
    ...
    [MESH_UI_FIELD_SF_HISTORY_MAX] = {{MESH_STR_SETTINGS_FIELD_SF_HISTORY_MAX,
                                       ...
                                       NULL, SCALE_PRESETS_AFTER_ZERO(k_sf_history_presets), 0U,
                                       MESH_STR_SETTINGS_NOTE_SF_HISTORY_MAX},
                                      INKCELL_STR_NONE,
                                      format_count},
    [MESH_UI_FIELD_SF_HISTORY_WINDOW] = {{MESH_STR_SETTINGS_FIELD_SF_HISTORY_WINDOW,
                                          MESH_UI_SETTING_NUMBER, MESH_UI_SETTINGS_STORE_FORWARD,
                                          0U, NULL, SCALE_PRESETS_AFTER_ZERO(k_sf_window_presets),
    ...
    [MESH_UI_FIELD_CHANNEL_UPLINK] = {{MESH_STR_SETTINGS_FIELD_CHANNEL_UPLINK,
                                       ...
                                       NO_PRESETS, 0U, MESH_STR_SETTINGS_NOTE_CHANNEL_UPLINK},
                                      INKCELL_STR_NONE,
                                      NULL},
    [MESH_UI_FIELD_CHANNEL_DOWNLINK] = {{MESH_STR_SETTINGS_FIELD_CHANNEL_DOWNLINK,
                                         MESH_UI_SETTING_TOGGLE, MESH_UI_SETTINGS_CHANNELS, 0U,
                                         NULL, NO_PRESETS, 0U,
                                         MESH_STR_SETTINGS_NOTE_CHANNEL_DOWNLINK},
                                        INKCELL_STR_NONE,
                                        NULL},
    [MESH_UI_FIELD_CHANNEL_POSITION] = {{MESH_STR_SETTINGS_FIELD_CHANNEL_POSITION,
                                         MESH_UI_SETTING_NUMBER, MESH_UI_SETTINGS_CHANNELS, 0U,
                                         NULL, NAMED_PRESETS(k_precision_presets), 0U,
    ...
    [MESH_UI_FIELD_SECURITY_ADMIN_CHANNEL] = {{MESH_STR_SETTINGS_FIELD_SECURITY_ADMIN_CHANNEL,
                                               MESH_UI_SETTING_TOGGLE, MESH_UI_SETTINGS_SECURITY,
                                               0U, NULL, NO_PRESETS, 0U,
    ...
    [MESH_UI_FIELD_NEIGHBOR_INTERVAL] = {{MESH_STR_SETTINGS_FIELD_NEIGHBOR_INTERVAL,
                                          MESH_UI_SETTING_NUMBER, MESH_UI_SETTINGS_NEIGHBOR_INFO,
                                          0U, NULL, SCALE_PRESETS(k_neighbor_presets), 0U,
    ...
    [MESH_UI_FIELD_DETECT_STATE_BROADCAST] = {{MESH_STR_SETTINGS_FIELD_DETECT_STATE_BROADCAST,
                                               ...
                                               0U, NULL, SCALE_PRESETS(k_detect_state_presets), 0U,
    ...
    [MESH_UI_FIELD_EXTNOTIF_OUTPUT_MS] = {{MESH_STR_SETTINGS_FIELD_EXTNOTIF_OUTPUT_MS,
                                           ...
                                           SCALE_PRESETS(k_output_ms_presets), 0U,
    ...
    [MESH_UI_FIELD_SECURITY_SIGNATURE_POLICY] = {{MESH_STR_SETTINGS_FIELD_SECURITY_SIGNATURE_POLICY,
                                                  ...
                                                  3U, signature_policy_name, NO_PRESETS, 0U,
    ...
    [MESH_UI_FIELD_UI_SCREEN_TIMEOUT] = {{MESH_STR_SETTINGS_FIELD_UI_SCREEN_TIMEOUT,
                                          ...
                                          NULL, SCALE_PRESETS_AFTER_ZERO(k_ui_timeout_presets), 0U,
...
const struct mesh_ui_form mesh_ui_settings_form = {k_fields, sizeof k_fields[0],
...
const struct field_spec *field_spec(enum mesh_ui_setting_field field) {
    return (const struct field_spec *)mesh_ui_form_field(&mesh_ui_settings_form, (uint16_t)field);
}
...
bool mesh_ui_settings_section_has_fields(enum mesh_ui_settings_section section) {
    return mesh_ui_form_section_has_fields(&mesh_ui_settings_form, (uint16_t)section);
}
...
uint32_t mesh_ui_settings_field_bit(enum mesh_ui_setting_field field) {
    return mesh_ui_form_bit(&mesh_ui_settings_form, (uint16_t)field);
}

uint32_t mesh_ui_settings_enum_count(enum mesh_ui_setting_field field) {
    return mesh_ui_form_enum_count(&mesh_ui_settings_form, (uint16_t)field);
}

const char *mesh_ui_settings_enum_name(enum mesh_ui_setting_field field, uint32_t value) {
    return mesh_ui_form_enum_name(&mesh_ui_settings_form, (uint16_t)field, value);
}

uint32_t mesh_ui_settings_number_step(enum mesh_ui_setting_field field, uint32_t value, int delta) {
    return mesh_ui_form_number_step(&mesh_ui_settings_form, (uint16_t)field, value, delta);
}
...
bool mesh_ui_settings_number_track(enum mesh_ui_setting_field field, uint32_t value,
    ...
    if (!mesh_ui_form_number_track(&mesh_ui_settings_form, (uint16_t)field, value, &track)) {
        return false;
    }
    if (out != NULL) {
...
uint32_t mesh_ui_settings_text_max(enum mesh_ui_setting_field field) {
    return mesh_ui_form_text_max(&mesh_ui_settings_form, (uint16_t)field);
}

uint32_t mesh_ui_settings_key_choices(enum mesh_ui_setting_field field) {
    return mesh_ui_form_key_choices(&mesh_ui_settings_form, (uint16_t)field);
}
