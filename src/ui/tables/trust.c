 ...
 */
static const enum inkcell_icon k_trust_icons[] = {
    [MESH_UI_KEY_TRUST_NONE] = INKCELL_ICON_NONE,
    [MESH_UI_KEY_TRUST_UNVERIFIED] = INKCELL_ICON_ENCRYPTED,
...
static const enum inkcell_tone k_trust_tones[] = {
    [MESH_UI_KEY_TRUST_NONE] = INKCELL_TONE_NORMAL,
    [MESH_UI_KEY_TRUST_UNVERIFIED] = INKCELL_TONE_NORMAL,
    [MESH_UI_KEY_TRUST_VERIFIED] = INKCELL_TONE_SUCCESS,
};
...
enum inkcell_tone mesh_ui_key_trust_tone(enum mesh_ui_key_trust trust) {
    return trust_in_range(trust) ? k_trust_tones[trust] : INKCELL_TONE_NORMAL;
}
...
bool mesh_ui_verify_sheet_of(const struct mesh_ui_verification *verification,
    ...
    case MESH_UI_VERIFY_SHOW_NUMBER:
        out->icon = INKCELL_ICON_SECURITY;
        ...
        inkcell_str_format(headline, headline_len, MESH_STR_VERIFY_VAL_NUMBER,
                           (unsigned)(verification->security_number / 1000U % 1000U),
                           (unsigned)(verification->security_number % 1000U));
        inkcell_str_format(text, text_len, MESH_STR_VERIFY_BODY_NUMBER, peer);
