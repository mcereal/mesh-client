...
static const struct uicap_scene_verb uicap_verbs[] = {
    ...
    {"toast", 0U, verb_toast},
    {"status", UICAP_SCENE_NO_SETTLE, verb_status},
    {"ack", UICAP_SCENE_NO_SETTLE, verb_ack},
    {"react", UICAP_SCENE_NO_SETTLE, verb_react},
    {"mute", UICAP_SCENE_NO_SETTLE, verb_mute},
    {"verified", UICAP_SCENE_NO_SETTLE, verb_verified},
    {"verify", UICAP_SCENE_NO_SETTLE, verb_verify},
    {"pin", UICAP_SCENE_NO_SETTLE, verb_pin},
    {"battery", UICAP_SCENE_NO_SETTLE, verb_battery},
    {"environment", UICAP_SCENE_NO_SETTLE, verb_environment},
    {"signal", UICAP_SCENE_NO_SETTLE, verb_signal},
    {"nofix", UICAP_SCENE_NO_SETTLE, verb_nofix},
    {"offradio", UICAP_SCENE_NO_SETTLE, verb_offradio},
    {"notice", UICAP_SCENE_NO_SETTLE, verb_notice},
    {"config", UICAP_SCENE_NO_SETTLE, verb_config},
    {"queue", UICAP_SCENE_NO_SETTLE, verb_queue},
    {"syncing", UICAP_SCENE_NO_SETTLE, verb_syncing},
    {"link", UICAP_SCENE_NO_SETTLE, verb_link},
    {"broker", UICAP_SCENE_NO_SETTLE, verb_broker},
    {"stats", UICAP_SCENE_NO_SETTLE, verb_stats},
    ...
    {"units", UICAP_SCENE_NO_SETTLE, verb_units},
    {"reboots", UICAP_SCENE_NO_SETTLE, verb_reboots},
    {"message", UICAP_SCENE_NO_SETTLE, verb_message},
    {"reply", UICAP_SCENE_NO_SETTLE, verb_reply},
    {"waypoint", UICAP_SCENE_NO_SETTLE, verb_waypoint},
    {"alert", UICAP_SCENE_NO_SETTLE, verb_alert},
    {"detection", UICAP_SCENE_NO_SETTLE, verb_detection},
};
